...
tmux bind-key -T tmux-window-focus n run-shell -b "$SCRIPTS_DIR/focus-next.sh"
tmux bind-key -T tmux-window-focus p run-shell -b "$SCRIPTS_DIR/focus-prev.sh"
...
tmux bind-key -T tmux-window-focus ? display-message -d 8000 "focus: 1-0 jump | n next | p prev | a add | A assign | d delete | m move | l list | s show | c clear"
